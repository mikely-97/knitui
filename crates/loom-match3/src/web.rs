// wasm-bindgen entry point driving match3's full Shell<M3Game> -- menus,
...
impl WebGame {
    ...
    pub fn new(ctx: CanvasRenderingContext2d, cols: u16, rows: u16, font_px: f64) -> WebGame {
        ...
        let config_dir = M3Game.config_dir();
        ...
        let shell = Shell::new(
            ...
            campaign_saves,
            endless_hs,
            Vec::new(), // match3 has no watch-an-ad feature (see native tui.rs)
            String::new(),
